...
The Bash installer is the main entrypoint. Profiles, helper scripts, cloud-init, manifests, and snapshot cleanup make it usable across many Ubuntu VMs.
...
Other Linux distributions may work for read-only planning, but Ubuntu is the supported workstation target for this edition.
